...
public class TaskController {
    ...
    @PostMapping("/entry")
    public ResponseEntity<TaskEntity> createEntity(@RequestBody Task task) {
    ...
    @PutMapping("/entry/{id}")
    public ResponseEntity<TaskEntity> updateData(@PathVariable Long id, @RequestBody Task task) {
